...
void redirecionar()
{
    system("cls");
    cout << endl << endl;
    cout << "A opção selecionada não é válida, será redirecionado ao ecrã "
            "anterior."
         << endl;
    sleep(2);
    system("cls");
    cout << endl << endl;
    cout << "A redirecionar para o ecrã anterior" << endl;
    sleep(1);
    system("cls");
    cout << endl << endl;
    cout << "A redirecionar para o ecrã anterior." << endl;
...
void redirecionar2()
{
    system("cls");
    cout << endl << endl;
    cout << "A redirecionar para o ecrã inicial" << endl;
    sleep(1);
    system("cls");
    cout << endl << endl;
    cout << "A redirecionar para o ecrã inicial." << endl;
...
HOME:
    ...
    else if (opcao1 == "3")
    {
        ...
        bonecoInteiro();
        cout << "Vai ser aberto o navegador com o site para o download do código "
                "fonte"
             << endl
             << endl;
        sleep(3);
        ShellExecute(NULL, "open", "https://github.com/andrealmeida19/Jogo-da-Forca", NULL, NULL,
            SW_SHOWNORMAL);
        main();
    }
...
{
    char palavraSecreta[255], tracos[255], letra;
    ...
    {
        system("cls");
        forca(erros); // forca com erros
        if (erros == 7)
        { // veririca se perdeu o jogo quando erros==7
            string opcao4;
        ...
        if (strcmp(palavraSecreta, tracos) == 0)
        { // palavras iguais Verifica se ganhou o jogo
        HOME5:
            string opcao5;
            system("cls");
            forca(erros);
        ...
        cout << "> ";
        scanf(" %c", &letra);
        int acertou_letra = 0; // 0=errado  1=acertou
...
HOME3:
    ...
    if (opcao3 == "1")
    {
        ...
        if (facil == 0)
        {
            system("cls");
            cout << endl << endl;
            cout << "A base de dados está em falta." << endl;
            sleep(2);
            system("cls");
            redirecionar3();
            goto HOME3;
        ...
        while (1)
        {
            ...
            cout << "Atenção: o sistema contém apenas palavras (não frases) e as "
                    "mesmas não têm acentuação."
                 << endl
                 << endl
                 << endl;
            cout << "Letras da palavra >";
